...
public:
  ...
  MOCK_METHOD2(transferHeaderTo, Network::FilterStatus(const Buffer::Instance&, size_t));
  MOCK_METHOD2(transferBodyTo, Network::FilterStatus(const Buffer::Instance&, size_t));
};
...
public:
  ...
  MOCK_CONST_METHOD0(name, const std::string&());
  MOCK_CONST_METHOD0(type, DeserializerType());
  ...
  MOCK_METHOD3(serializeRpcResult, void(Buffer::Instance&, const std::string&, uint8_t));

  std::string name_{"mockDeserializer"};
  DeserializerType type_{DeserializerType::Hessian};
};
...
public:
  ...
  MOCK_METHOD3(messageBegin, Network::FilterStatus(MessageType, int64_t, SerializationType));
  MOCK_METHOD1(messageEnd, Network::FilterStatus(MessageMetadataSharedPtr));
  MOCK_METHOD2(transferHeaderTo, Network::FilterStatus(const Buffer::Instance& buf, size_t size));
  MOCK_METHOD2(transferBodyTo, Network::FilterStatus(const Buffer::Instance& buf, size_t size));
};
...
public:
  ...
  MOCK_CONST_METHOD0(downstreamDeserializerType, DeserializerType());
...
public:
  ...
  createFilterFactoryFromProto(const Protobuf::Message& proto_config,
    ...
    return createFilterFactoryFromProtoTyped(
        typed_config, stats_prefix, context);
  }
