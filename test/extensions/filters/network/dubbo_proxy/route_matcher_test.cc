...
routes:
  ...
  metadata.setServiceName("org.apache.dubbo.demo.DemoService");
  metadata.setMethodName("add");
  metadata.addParameterValue(0, "int", "150");
...
routes:
  ...
  metadata.setServiceName("org.apache.dubbo.demo.DemoService");
  metadata.setMethodName("add");
  metadata.addParameterValue(1, "string", "user_id:94562");
...
routes:
  ...
  metadata.setServiceName("org.apache.dubbo.demo.DemoService");
  metadata.setMethodName("add");
  metadata.addHeaderValue("custom", "123");
  std::string test_value("123");

  Envoy::Http::LowerCaseString test_key("custom1");
  metadata.addHeaderReferenceValue(test_key, test_value);
...
route_config:
  ...
  metadata.setServiceName("org.apache.dubbo.demo.DemoService");
  metadata.setMethodName("add");
  metadata.addParameterValue(1, "string", "user_id");
